...
export default {
  ...
  methods: {
    ...
    UpdateBracket(){
      ...
      axios.post('http://localhost:5000/bracket/create' , UpdateThisBracket)  
              .then((response) => {
                console.log('UPDATE : ' + this.tourName + ',,, _id ' + '5cd462c8612008638cf6f573')
  ...
  mounted() {
    ...
    axios.post("http://localhost:5000/profile/checkLogin",this.$route.params.id)
      .then(response =>{
             ...
             axios.post('http://localhost:5000/bracket/show' , ShowThisBracket)  
              .then((response) => {
                ...
                this.Detail = response.data.Detail
                  ...
                  console.log('This Bracket id : ' + ShowThisBracket._id) //console.log('This Bracket id : ' + this.$route.params.newID)
